...
class Psikolog(Base):
    ...
    nik: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    nama_bank: Mapped[str | None] = mapped_column(Text, nullable=True)
    nomor_rekening: Mapped[str | None] = mapped_column(Text, nullable=True)
    nama_penerima_rekening: Mapped[str | None] = mapped_column(Text, nullable=True)
    apakah_rekening_terverifikasi: Mapped[bool | None] = mapped_column(Boolean, default=False)
