      ...
      <div className="max-w-[940px]">
        ...
        <DashboardCard className="px-8 py-12 text-center md:px-14">
          ...
          <p className="mx-auto mt-4 max-w-[640px] text-[16px] leading-7 text-on-surface-variant">
            Selesaikan screening awal terlebih dahulu. Setelah psikolog meninjau hasil
            refleksimu dan merekomendasikan konsultasi lanjutan, jadwal yang tersedia
          ...
          <div className="mx-auto mt-8 grid max-w-[700px] gap-4 text-left md:grid-cols-3">
            {[
              ...
              <div key={step} className="rounded-[14px] bg-surface-container px-4 py-4">
                <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-primary-container text-sm font-bold text-white">
                  {index + 1}
                </div>
                <p className="text-sm font-semibold leading-5 text-on-surface">{step}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-9 flex flex-wrap justify-center gap-3">
            <Link
              ...
              className="inline-flex h-12 items-center justify-center rounded-full bg-primary-container px-7 text-[15px] font-semibold text-white transition hover:bg-[#789477]"
            >
              Mulai Screening
            </Link>
            <Link
